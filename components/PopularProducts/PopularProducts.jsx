    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (response.data.status === 'success' && response.data.data[10].content.length > 0) {
                    setData(response.data.data[10].content);
                } else {
    ...
    return (<>
        <div className="md:my-5 mx-3 order-1 ">
            <div>
                ...
                {loading ? <Loading/> : <div className="row-container" id="sliderB">
                                ...
                                <div
                                    ...
                                    <div className="Frame22 w-32 justify-start items-center gap-2 inline-flex">
                                        <div className="00Sar w-20">
                                                      <span
                                                          className="text-zinc-950 text-xl font-bold  leading-relaxed">
                                                       {item.price}
                                                      </span>
                                            <span
                                                className="text-zinc-950 text-sm font-bold  leading-tight">{item.currency}
                                                        </span>
                                        </div>
                                    </div>
                                    <div
